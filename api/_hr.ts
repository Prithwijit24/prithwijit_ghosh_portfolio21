// HR / behavioral interview Q&A for the "Interview Me" chatbot.
//
// Each entry is a self-contained knowledge-base passage (question + first-person
// answer) so the RAG can retrieve the closest match and answer common HR /
// behavioral questions consistently. Answers are grounded in the résumé facts
// in _rag.ts (Accenture role, forecasting & risk results, IIT Kanpur M.Sc.,
// projects, skills) — they don't invent new numbers, employers or dates.
export const HR_QA: string[] = [
  ...
  `HR — "How do you communicate complex results to leadership?": I lead with the business outcome and the decision it supports, then offer detail if asked. For the AR and forecasting work I used Power BI dashboards so leadership could explore the results themselves.`,
